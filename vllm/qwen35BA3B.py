...
def main():
    # Create an LLM.
    llm = LLM(model="/home/chaos/prjs/models/Qwen3.5-35B-A3B",revision=None,
    gpu_memory_utilization=GMU,enforce_eager=True,max_model_len=MML, 
    quantization="fp8", block_size=64, max_num_batched_tokens=8192, max_num_seqs=1)
