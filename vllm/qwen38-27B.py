...
import time
import random
INPUT_LENS=[1024, 2048, 4096, 8192, 10240]#, 80_000],,, 80K 会OOM
...
def main():
    random.seed(0)
    llm = LLM(model="/home/chaos/prjs/models/Qwen3.8-27B",
              ...
              max_num_seqs=MNS,         #最大并发数
              disable_log_stats=True,  #禁用日志
              enable_prefix_caching=False)
    infer = itt.domain_create("infer.vLLM.Qwen38-27B")
